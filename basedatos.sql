...
-- Tiempo de generación: 10-05-2023 a las 15:45:23
...
(1052452132, 'Alejandra', 'Alvarado', 19, 'Paciente'),
(1052452134, 'Jorge', 'Castro', 21, 'Paciente'),
(1055428271, 'Samantha', 'Noelis', 21, 'Paciente'),
(1059712453, 'Camilo', 'Sánchez', 37, 'Asesor'),
(1068593751, 'Samuel', 'Velazquez', 19, 'Paciente'),
(1069582730, 'Andrea', 'Leon', 27, 'Paciente'),
(1069582752, 'Ale', 'Alba', 19, 'Paciente'),
(1069582754, 'Camilo', 'Sánchez', 29, 'Paciente'),
(1069582761, 'Alex', 'Alba', 25, 'Asesor'),
(1069582763, 'Andrea', 'Leon', 28, 'Paciente'),
(1069582852, 'Edson', 'Calisaya', 28, 'Paciente'),
(1069584765, 'Paola', 'Mendez', 28, 'Paciente'),
...
--
ALTER TABLE `tablausers`
  MODIFY `ID` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2012144515;
COMMIT;
